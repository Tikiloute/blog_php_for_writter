...
?>    
                <div class="card justify-content-center">
                    <div class="card-body justify-content-center">
                        ...
                        <a href="index.php?action=warning&amp;read=<?php echo $commentsPaging[$i]['idArticle']?>&amp;id=<?php echo $commentsPaging[$i]['identifiant'] ?>&amp;idCommentaire=<?php echo $commentsPaging[$i]['id'] ?>&amp;commentaire=<?php echo $commentsPaging[$i]['commentaire'] ?>&amp;date=<?php echo $commentsPaging[$i]['date']?>&amp;comment=<?php echo $_GET['comment']?> " >Signalez ce commentaire</a>
                    </div>
                </div>
<?php 
            }
