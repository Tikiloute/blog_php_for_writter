...
?>    
                <div class="card ">
                    <div class="card-body">
                        ...
                        <a href="index.php?read=<?php echo $comments[$i]['idArticle']?>&amp;id=<?php echo $comments[$i]['identifiant'] ?>&amp;comment=<?php echo $comments[$i]['commentaire'] ?>&amp;date=<?php echo $comments[$i]['date']?> " >Signalez ce commentaire</a>
                    </div>
                </div>
<?php 
            }
