...
?>    
                <div class="card mt-12">
                    <div class="card-body mt-4">
                        ...
                        <p class="card-text"><?php echo "A propos de l'article : "?><a href="index.php?action=reading&read=<?php echo $warnings[$i]['idArticle']?>&comment=1"><?php echo $warnings[$i]['NomArticle']?></a></p>
